...
public class Frm_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelMain = new javax.swing.JPanel(){
            public void paintComponent (Graphics g){
                ImageIcon icon = new ImageIcon("src/resource/sach.jpg");
                Dimension d = getSize();
                g.drawImage(icon.getImage(), 0, 0, d.width, d.height, null);
                setOpaque(false);
                super.paintComponent(g);
        ...
        tabMain.setBackground(new java.awt.Color(255, 255, 153));
        ...
        tabMain.addTab("Cấu hình", new javax.swing.ImageIcon(getClass().getResource("/resource/Comment.png")), jPanel3); // NOI18N
