                ...
                for (int j = 0; j < f.length; j++) {
                    ...
                    if (f[j].getType().equals(Long.class)) {
                        try {
                            ...
                            Long idLong = Long.parseLong(myRow.getCell((short) j).toString());
                            f[j].set(obj, idLong);
                        ...
                        try {
                            int idInteger = Integer.parseInt(myRow.getCell((short) j).toString().trim());
                        ...
                        try {
                            double d = Double.parseDouble(myRow.getCell((short) j).toString().trim());
                            f[j].set(obj, d);
                        } catch (NumberFormatException ex) {
                            f[j].set(obj, 0);
                        }
                        ...
                        f[j].set(obj, myRow.getCell((short) j).getBooleanCellValue());
                    } else if (f[j].getType().equals(Calendar.class)) {
                        try {
                            Calendar calendar = Calendar.getInstance();
                            Date date = myRow.getCell((short) j).getDateCellValue();
                        ...
                        try {
                            String s = myRow.getCell((short) j).getStringCellValue();
                        ...
                        if (myRow.getCell((short) j) == null) {
                            f[j].set(obj, null);
                        } else {
                            try {
                                String value = myRow.getCell((short) j).toString();
                                f[j].set(obj, value);
                            } catch(Exception ex){
                                f[j].set(obj, null);
